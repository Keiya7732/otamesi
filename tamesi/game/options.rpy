...
define config.save_directory = "tamesi-1567155807"
...
## Mac のコード署名を有効にするために Apple Developer ID アプリケーション を含む
## 文字列を設定します。必ず Apple が発行したあなたの ID に変更してください。
